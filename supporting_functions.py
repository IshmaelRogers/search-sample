...
def create_output_images(Rover):
      ...
      cv2.putText(map_add, "State: " + str(Rover.mode[-1]), (0, 100),
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add, "Home Position x: " + str(Rover.homepos[0]), (0, 115),
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1) 
      cv2.putText(map_add, "Home Position y: " + str(Rover.homepos[1]), (0, 130),
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add, "Distance 4rm home: " + str(Rover.home[0]), (0, 145),cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1) 
      cv2.putText(map_add, "to get home: " + str(Rover.home[1]), (0, 160),
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)

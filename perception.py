...
def perception_step(Rover):
    ...
    if Rover.homepos == None:
        Rover.homepos = Rover.pos
    img = Rover.img
    dst_size = 5
    bottom_offset = 6 
    ...
    #obstacles are opposite of navigable terrain 
    ...
    #igore half of the image as bad data
    ...
    scale = dst_size*2 
    navigable_x_world, navigable_y_world = pix_to_world(xpix_navigable, ypix_navigable, Rover.pos[0], Rover.pos[1], Rover.yaw, Rover.worldmap.shape[0], scale)
    obstacle_x_world, obstacle_y_world = pix_to_world(xpix_obstacles, ypix_obstacles, Rover.pos[0], Rover.pos[1], Rover.yaw, Rover.worldmap.shape[0], scale)
    rock_x_world, rock_y_world = pix_to_world(xpix_rocks, ypix_rocks, Rover.pos[0], Rover.pos[1], Rover.yaw, Rover.worldmap.shape[0], scale)
    home_x_world, home_y_world = pix_to_world(Rover.homepos[0], Rover.homepos[1], Rover.pos[0], Rover.pos[1], Rover.yaw, Rover.worldmap.shape[0], scale)
    ...
    if (Rover.pitch < 0.4 or Rover.pitch > 359) and (Rover.roll < 0.4 or Rover.roll > 359):
        # increment = 10
        Rover.worldmap[obstacle_y_world, obstacle_x_world, 0] = 255
        Rover.worldmap[rock_y_world, rock_x_world,1] = 255
        Rover.worldmap[navigable_y_world, navigable_x_world, 2] = 255
        Rover.worldmap[home_y_world, home_x_world, 2] = 255
    ...
    # roc sample polar coordinates used to steer towards rocks
    dist, angles = to_polar_coords(xpix_rocks, ypix_rocks)
    Rover.samples_dists = dist
    Rover.samples_angles = angles
    
     # roc sample polar coordinates used to steer towards rocks
    dist, angles = to_polar_coords(Rover.homepos[0], Rover.homepos[1])
    Rover.home = (dist, angles)

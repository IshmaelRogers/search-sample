...
def findHome(Rover):
    ...
    offset = 0
    #apply left  hug when out of the starting point after 10s)
        ...
        if Rover.mode[-1] == 'forward':
            ...
            #before initiating braking
                ...
                if Rover.vel <= 0.1 and Rover.total_time - Rover.stuck_time > 4:
                    ...
                    Rover.mode.append('stuck')
                    Rover.stuck_time = Rover.total_time
                # if velocity is below max, then accelerate
                elif Rover.vel < Rover.max_vel:
                    # Set throttle value
                    Rover.throttle = Rover.throttle_set
                else: # Else coast
            ...
            # If "stuck". Stay here for 1.5 sec
            ...
            #determine if a path forward is possible
            else:
                Rover.throttle = 0
                # dont break 
                Rover.brake = 0
            ...
            # if stuck while trying to find rocks go to stuck mode
